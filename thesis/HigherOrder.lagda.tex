  ...
  \begin{center}
    \begin{tikzpicture}[level distance=1.0cm,sibling distance=1.5cm]
      \node[treenode] at (0,0) {\textbf{catch}$_X$}
          ...
          child[sibling distance=1.3cm] {
              node[treenode] {\textbf{h}} edge from parent node[right,draw=none] {$e$}
          }
          child[sibling distance=1.3cm] {
              node[treenode] {\textbf{cont}} edge from parent node[right,draw=none,xshift=0.1cm] {$x$}
          }
      ;

      \node at (3.0,-0.5) {$\gg\!\!=\;k\quad \equiv$};

      \node[treenode] at (5.8,0) {\textbf{catch}$_X$}
          child[sibling distance=1.3cm] {
              node[treenode] {\textbf{p}}
          }
          child[sibling distance=1.3cm] {
          ...
          child[sibling distance=1.3cm] {
              node[treenode] {\textbf{cont}$\;\bind{}\; k$} edge from parent node[right,draw=none,xshift=0.1cm] {$x$}
          }
      ;
    \end{tikzpicture}
  \end{center}
