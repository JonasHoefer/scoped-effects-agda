...
\begin{abstract}
  ...
  effects in constructive type theory.
  For example,
  \cite{DBLP:journals/programming/DylusCT19,DBLP:conf/haskell/ChristiansenDB19}
  used them to explicitly represent ambient effect, such as Haskell's
  partiality, in proof assistants like Coq.
