...
Or lastly, an operations with a local scope, represented by the second signature
$\Gamma$.
...
scope.
In case of a sharing scope we number choices inside the scope unsing the scopes
