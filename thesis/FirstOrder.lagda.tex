...
We are more interessted in this formulation using \AgdaFunction{>>=}, because it
is the one occuring more directly in programs.
...
When ever a choice with a choice id is encountered the decision is remembered.
...
\textcite{DBLP:conf/icfp/FischerKS09} introduced a set of equations
