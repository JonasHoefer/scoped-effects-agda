...
a strictly positive functor, which was represented as \AgdaDatatype{Container}.
...
Because some equations just \AgdaFunction{get} and \AgdaFunction{put},
\AgdaArgument{ops} cannot be automatically infered.
...
They presented two runNondet to explicitly declare how far an operations scopes
...
prove termination we again have to add \AgdaDatatype{Size} annotations to the
functions.
