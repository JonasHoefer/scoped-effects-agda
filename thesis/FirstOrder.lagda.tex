...
Therefore, the program does not call impure operations and always yields a value
of type \AgdaArgument{A}.
...
nondeterministically produces a boolean or having two continuations.
...
The \AgdaFunction{bcall} and \AgdaFunction{ecall} handler removes the scope
