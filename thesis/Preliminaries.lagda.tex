...
The current version (Agda 2.6.1.1 and std-lib 1.4 as of Nov 2020) was originally
developed by \textcite{norell:thesis} under the name Agda2.
...
These two correspond to the two elements of a $\Sigma$ type.
...
One of the most important propositions is equality, i.e. the proposition that
...
equality together with the analogues of proofs by exhaustion and induction.
...
operation by itself, i.e. not handle it.
...
\mintinline{haskell}{Pure} computation that returns the value.
