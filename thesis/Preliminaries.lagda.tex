...
the \AgdaDatatype{Size<\_} family of types\footnote{We will not need this
...
\AgdaDatatype{Rose}\AgdaSpace{}\AgdaArgument{A}$($\AgdaFunction{↑}\AgdaSpace{}\AgdaArgument{i}$)$.
...
% This allows a clear separation of syntax and semantics.
% - delays evaluation
% - different evaluation possible
