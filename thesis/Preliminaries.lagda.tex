...
Agda's syntax is similar to Haskell's.
...
\AgdaDatatype{Size<\_}\footnote{We will not use this construction. It is usually
...
i.e. each monad can be described as the image of a monad homomorphisms from a
free monad.
...
the free monad, is a well known approach.
